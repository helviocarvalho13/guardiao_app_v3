...
class DevParceriaRepository implements ParceriaRepository{
  ...
  var parcerias = <Parceria> [
    new Parceria('224', 'Renovada', 'ACADEMIA BODYTECH', 'ACADEMIAS', 'SAÚDE', '', '0% em qualquer plano e 50% na taxa de adesão',
    ...
    new Parceria('225', 'Renovada', 'ALEXIA FLORES', 'FLORICULTURA', 'FLORICULTURA', '', '5% na tabela de atacado que inclui floricultura e decorador e 10% nos produtos prontos e acabados da floricultura e da lojinha',
        'Av. Daniel de La Touche, N°987 , loja 118, Shopping da Ilha',
